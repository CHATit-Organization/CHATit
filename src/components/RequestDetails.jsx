...
function RequestDetails() {
  ...
  return (
    <div className="details-container flex flex-col w-[300px] h-auto justify-between gap-[20px] items-center">
      ...
      {/* value */}
      <p className="details-value text-[#7758D1] font-bold text-lg">${amount}</p>
      <div className="details-flex-container  w-full">
        ...
        <div className="details-flex flex justify-between items-center">
          ...
          <p className="details-subject  text-sm italic details-desc  w-[200px] truncate">{remarks}</p>
        </div>
      </div>

      {/* <button className="details-send-btn">Send</button> */}
      <button className={`details-send-btn flex w-[100px] h-[30px] bg-[#7758d1] rounded-lg items-center justify-center hover:bg-opacity-75 active:bg-opacity-60 shadow-2xl `} onClick={setSuccess(true)}>
        Request
      </button>
